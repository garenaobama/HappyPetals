...
export const ShowCase1 = ({ }: ShowCase1Prop): React.JSX.Element => {
    ...
    return (exploreProgress == 0 ? <div style={{ height: '85vh', justifyContent: 'center' }} className="fixed container mt-20 flex flex-col justify-center mb-5">
        <div className="grid grid-cols-2 gap-20 relative">
            <div className="relative justify-center flex flex-col">
                <motion.div initial={{ opacity: 0, x: "-100%" }}
                    ...
                    <div className="flex flex-col gap-10 pl-24">
                        ...
                        <p style={{fontSize: '0.75rem'}} className="text-3xl">&quot;Hoa khô, với vẻ đẹp vĩnh cửu, luôn mang trong mình một câu chuyện vĩnh hằng trong trái tim của những người yêu hoa. Chúng không phải chỉ là những bông hoa tàn úa, mà còn là biểu tượng của sự kiên nhẫn và sự sống mãi mãi&quot;</p>
                    </div>
                </motion.div>
            ...
            <motion.div className="flex items-center" initial={{ opacity: 0, x: "100%" }}
                animate={{ opacity: 1, x: 0 }}
                exit={{ opacity: 0, x: "100%" }}>
                <Image alt="thumbnail" style={{width: '80%', height: '80%'}} src={Images.HoaKho1} />
            </motion.div>
